...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {
    ...
    {
        TextView textclose, city_name,city_desc,city_earning,city_status,city_date;
        String title,earning,status,date;
        ImageView imageView;
        Button button_fav;
        ...
        city_date = (TextView) myDialog.findViewById(R.id.date_popup);
        city_status = (TextView) myDialog.findViewById(R.id.status_popup);
        city_earning = (TextView) myDialog.findViewById(R.id.earning_popup);
        ...
        earning = mData.get(p).getEarning();
        date = mData.get(p).getDate();
        status = mData.get(p).getStatus();
        city_name.setText(title);
        city_earning.setText(earning);
        city_date.setText(date);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView country_name,earning,date,status;
